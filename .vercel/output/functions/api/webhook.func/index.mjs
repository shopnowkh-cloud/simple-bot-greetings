...
// src/lib/telegram/bot.ts
var _pool = new Pool({ connectionString: process.env.DATABASE_URL });
...
var BTN_ADD_ACCOUNT = "\u2795 \u1794\u1793\u17D2\u1790\u17C2\u1798 \u1782\u17BC\u1794\u17C9\u17BB\u1784";
var BTN_DELETE_TYPE = "\u{1F5D1} \u179B\u17BB\u1794\u1794\u17D2\u179A\u1797\u17C1\u1791";
var BTN_STOCK = "\u{1F4E6} \u179F\u17D2\u178F\u17BB\u1780 \u1782\u17BC\u1794\u17C9\u17BB\u1784";
var BTN_USERS = "\u{1F465} \u17A2\u17D2\u1793\u1780\u1794\u17D2\u179A\u17BE\u1794\u17D2\u179A\u17B6\u179F\u17CB";
var BTN_BUYERS = "\u{1F4CB} \u179A\u1794\u17B6\u1799\u1780\u17B6\u179A\u178E\u17CD\u1791\u17B7\u1789";
var BTN_KHPAY = "\u{1F4B0} KhPay API";
var BTN_CHANNEL = "\u{1F4E2} Channel ID";
var BTN_ADMINS = "\u{1F451} \u1782\u17D2\u179A\u1794\u17CB\u1782\u17D2\u179A\u1784 Admin";
var BTN_MAINTENANCE = "\u{1F6E0} Maintenance Mode";
var BTN_BROADCAST = "\u{1F4E2} \u1795\u17D2\u179F\u17B6\u1799\u1796\u17D0\u178F\u17CC\u1798\u17B6\u1793";
var BTN_BACK_SETTINGS = "\u2B05\uFE0F";
var BTN_KHPAY_KEY_EDIT = "\u270F\uFE0F \u1794\u17D2\u178F\u17BC\u179A KhPay API Key";
var BTN_KHPAY_INFO = "\u{1F4CA} \u1796\u17D0\u178F\u17CC\u1798\u17B6\u1793 KhPay";
var BTN_CHANNEL_EDIT = "\u270F\uFE0F \u1794\u17D2\u178F\u17BC\u179A Channel ID";
var BTN_CHANNEL_CLEAR = "\u{1F5D1} \u179B\u17BB\u1794 Channel ID";
var BTN_ADMIN_ADD = "\u2795 \u1794\u1793\u17D2\u1790\u17C2\u1798 Admin";
var BTN_ADMIN_REMOVE = "\u2796 \u178A\u1780 Admin";
var BTN_MAINT_ON = "\u{1F534} \u1794\u17B7\u1791 Bot";
var BTN_MAINT_OFF = "\u{1F7E2} \u1794\u17BE\u1780 Bot";
var BTN_CANCEL_INPUT = "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB";
var BTN_DELETE_CONFIRM = "\u2705 \u1794\u1789\u17D2\u1787\u17B6\u1780\u17CB\u179B\u17BB\u1794";
var BTN_DELETE_CANCEL = "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB\u1780\u17B6\u179A\u179B\u17BB\u1794";
var BTN_BROADCAST_CONFIRM = "\u2705 \u1794\u1789\u17D2\u1787\u17B6\u1780\u17CB\u1795\u17D2\u179F\u17B6\u1799";
var BTN_BROADCAST_CANCEL = "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB\u1780\u17B6\u179A\u1795\u17D2\u179F\u17B6\u1799";
var ADMIN_BUTTON_LABELS = /* @__PURE__ */ new Set([
  BTN_ADD_ACCOUNT,
  BTN_DELETE_TYPE,
  BTN_STOCK,
  BTN_USERS,
...
var kb = (rows) => ({ keyboard: rows, resize_keyboard: true, is_persistent: true });
var MAIN_KB = kb([["\u{1F4B5} \u1791\u17B7\u1789\u1782\u17BC\u1794\u17C9\u17BB\u1784"]]);
var ADMIN_SETTINGS_KB = kb([
...
var CANCEL_INPUT_KB = kb([[BTN_CANCEL_INPUT]]);
var ADD_ACCOUNT_KB = kb([[BTN_BACK_SETTINGS]]);
var BACK_SETTINGS_KB = kb([[BTN_BACK_SETTINGS]]);
var KHPAY_SUBMENU_KB = kb([[BTN_KHPAY_KEY_EDIT, BTN_KHPAY_INFO], [BTN_BACK_SETTINGS]]);
var CHANNEL_SUBMENU_KB = kb([[BTN_CHANNEL_EDIT, BTN_CHANNEL_CLEAR], [BTN_BACK_SETTINGS]]);
var ADMINS_SUBMENU_KB = kb([[BTN_ADMIN_ADD, BTN_ADMIN_REMOVE], [BTN_BACK_SETTINGS]]);
var MAINTENANCE_SUBMENU_KB = kb([[BTN_MAINT_ON, BTN_MAINT_OFF], [BTN_BACK_SETTINGS]]);
var BROADCAST_CONFIRM_KB = kb([[BTN_BROADCAST_CONFIRM], [BTN_BROADCAST_CANCEL]]);
var REMOVE_KB = { remove_keyboard: true };
var CHECK_PAYMENT_INLINE = {
  inline_keyboard: [[
    { text: "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB", callback_data: "cancel_purchase" },
    { text: "\u2705 \u1794\u17B6\u1793\u1794\u1784\u17CB\u1794\u17D2\u179A\u17B6\u1780\u17CB", callback_data: "check_payment" }
  ]]
};
var PAYMENT_TIMEOUT_SEC = 60;
var esc = (s) => String(s).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
var KH_TZ = "Asia/Phnom_Penh";
var nowKH = () => (/* @__PURE__ */ new Date()).toLocaleString("sv-SE", { timeZone: KH_TZ }).replace("T", " ") + " +07";
var nowKHFile = () => (/* @__PURE__ */ new Date()).toLocaleString("sv-SE", { timeZone: KH_TZ }).replace(/[-: ]/g, "").slice(0, 14);
var fmtKH = (iso) => iso ? new Date(iso).toLocaleString("sv-SE", { timeZone: KH_TZ }).replace("T", " ") + " +07" : "\u2014";
var shortLabel = (t, n = 36) => {
  const c = t.trim();
  return c.length <= n ? c : c.slice(0, n - 1) + "\u2026";
};
var typeCallbackId = (at) => createHash("sha1").update(at).digest("hex").slice(0, 12);
...
var CAMBO_BASE = "https://bakong.cambo-kh.com/api/v2";
...
async function generatePlainQR(qr_string) {
  return import_qrcode.default.toBuffer(qr_string, {
...
async function createKhpayPayment(token, amount) {
  try {
    const res = await camboRequest(token, { type: "generate_qr", amount }, { timeoutMs: 25e3, retries: 2 });
    ...
    if (!imgBuffer && imgUrl) {
      try {
        const r = await fetch(imgUrl, { signal: AbortSignal.timeout(15e3) });
...
async function checkKhpayStatus(token, transaction_id, md5) {
  try {
    ...
    const data = await camboRequest(token, { type: "check_md5", md5: checkMd5 }, { timeoutMs: 15e3, retries: 1 });
...
var isAdmin = (ctx, uid) => Number(uid) === ctx.ADMIN_ID || ctx.EXTRA_ADMIN_IDS.has(Number(uid));
...
var typeFromCbId = (ctx, cid) => Object.keys(ctx.db.accounts.account_types).find((t) => typeCallbackId(t) === cid) ?? null;
async function notifyAdminNewUser(ctx, user) {
  ...
  sendMessage(
    ctx.ADMIN_ID,
    `\u{1F195} <b>\u17A2\u17D2\u1793\u1780\u1794\u17D2\u179A\u17BE\u1794\u17D2\u179A\u17B6\u179F\u17CB\u1790\u17D2\u1798\u17B8!</b>

\u{1F464} \u1788\u17D2\u1798\u17C4\u17C7: ${esc(full)}
\u{1F516} Username: ${esc(uname)}
\u{1FAAA} ID: <code>${uid}</code>`
  ).catch(() => {
  });
}
async function showAccountSelection(ctx, chatId) {
  const available = Object.entries(ctx.db.accounts.account_types).filter(([, v]) => v.length > 0).map(([at, v]) => ({ at, count: v.length }));
  if (!available.length) {
    await sendMessage(chatId, "<i>\u179F\u17BC\u1798\u17A2\u1797\u17D0\u1799\u1791\u17C4\u179F \u17A2\u179F\u17CB\u1796\u17B8\u179F\u17D2\u178F\u17BB\u1780 \u{1FAA4}</i>");
    return;
  }
...
\u1782\u17D2\u1798\u17B6\u1793 \u1782\u17BC\u1794\u17C9\u17BB\u1784 \u1794\u17D2\u179A\u1797\u17C1\u1791 ${esc(at)} \u1780\u17D2\u1793\u17BB\u1784\u179F\u17D2\u178F\u17BB\u1780\u17D4`);
  ...
  for (let i = 0; i < delivered.length; i++) {
    ...
    const msg = `\u{1F389} <b>\u1780\u17B6\u179A\u1791\u17B7\u1789\u1794\u17B6\u1793\u1794\u1789\u17D2\u1787\u17B6\u1780\u17CB\u178A\u17C4\u1799\u1787\u17C4\u1782\u1787\u17D0\u1799</b>

\u1782\u17BC\u1794\u17C9\u17BB\u1784\u179A\u1794\u179F\u17CB\u17A2\u17D2\u1793\u1780\u17D6 \u{1F447}

<code>${esc(formatAccount(acc))}</code>

<i>\u179F\u17BC\u1798\u17A2\u179A\u1782\u17BB\u178E\u179F\u1798\u17D2\u179A\u17B6\u1794\u17CB\u1780\u17B6\u179A\u1791\u17B7\u1789 \u{1F64F}</i>`;
    await sendMessage(chatId, msg, isLast ? await mainKb(ctx, userId) : void 0);
  }
  try {
    ...
    const adminMsg = `\u{1F389} <b>\u1791\u1791\u17BD\u179B\u1794\u17B6\u1793\u1780\u17B6\u179A\u1794\u1784\u17CB\u1794\u17D2\u179A\u17B6\u1780\u17CB\u1787\u17C4\u1782\u1787\u17D0\u1799</b>
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\u{1F194} <b>\u17A2\u17D2\u1793\u1780\u1791\u17B7\u1789(ID):</b> ${userId}
\u{1F4E6} <b>\u1794\u17D2\u179A\u1797\u17C1\u1791:</b> ${esc(at)} \xD7 ${qty}
\u{1F4B5} <b>\u1791\u17B9\u1780\u1794\u17D2\u179A\u17B6\u1780\u17CB:</b> $${session.total_price}
\u{1F464} <b>\u1796\u17B8\u1792\u1793\u17B6\u1782\u17B6\u179A:</b> <code>${esc(fromAcc)}</code>
\u{1F4DD} <b>\u1785\u17C6\u178E\u17B6\u17C6:</b> ${esc(memo)}
\u{1F9FE} <b>\u179B\u17C1\u1781\u1799\u17C4\u1784:</b> <code>${esc(ref)}</code>
\u23F0 <b>\u1798\u17C9\u17C4\u1784:</b> ${nowKH()}`;
  ...
  console.log(`[INFO] Delivered ${qty}\xD7 ${at} to user ${userId}`);
}
async function runWatchdog(preCtx) {
  let ctx;
  if (preCtx) {
    ctx = preCtx;
  } else {
  ...
  for (const [uidStr, sess] of pending) {
    ...
    if (elapsed >= PAYMENT_TIMEOUT_SEC * 1e3) {
...
async function exportStock(ctx, chatId) {
  const types2 = ctx.db.accounts.account_types;
  const prices = ctx.db.accounts.prices;
  const names = Object.keys(types2).sort();
  if (!names.length) {
    await sendMessage(chatId, "\u{1F4E6} \u1798\u17B7\u1793\u1798\u17B6\u1793\u1794\u17D2\u179A\u1797\u17C1\u1791 \u1782\u17BC\u1794\u17C9\u17BB\u1784 \u17A1\u17BE\u1799\u1791\u17C1\u17D4", ADMIN_SETTINGS_KB);
    return;
  }
  const totalAvail = names.reduce((s, t) => s + (types2[t] || []).length, 0);
  const W = 60;
  const lines = [
    "=".repeat(W),
  ...
  for (const t of names) {
    ...
    lines.push(`[ ${t} ]  \u{1F4B0} $${price}  \u{1F4E6} ${pool.length} \u1782\u17BC\u1794\u17C9\u17BB\u1784`, "\u2500".repeat(W));
  ...
  await sendDocument(chatId, buf, `stock_${nowKHFile()}.txt`, `\u{1F4E6} <b>\u179F\u17D2\u178F\u17BB\u1780 \u1782\u17BC\u1794\u17C9\u17BB\u1784</b> \u2014 ${names.length} \u1794\u17D2\u179A\u1797\u17C1\u1791, ${totalAvail} \u1793\u17C5\u179F\u179B\u17CB`);
...
async function exportBuyers(ctx, chatId) {
  ...
  const buf = Buffer.from(lines.join("\n"), "utf8");
  await sendDocument(chatId, buf, `buyers_${nowKHFile()}.txt`, `\u{1F4CB} \u179A\u1794\u17B6\u1799\u1780\u17B6\u179A\u178E\u17CD\u1791\u17B7\u1789 \u2014 ${Object.keys(grouped).length} \u17A2\u17D2\u1793\u1780\u200B\u1791\u17B7\u1789`);
  await sendAdminSettingsMenu(ctx, chatId);
}
async function showUsersList(ctx, chatId) {
  const rows = Object.entries(ctx.db.users);
  if (!rows.length) {
    await sendMessage(chatId, "\u{1F4ED} <b>\u1798\u17B7\u1793\u1791\u17B6\u1793\u17CB\u1798\u17B6\u1793\u17A2\u17D2\u1793\u1780\u1794\u17D2\u179A\u17BE\u1794\u17D2\u179A\u17B6\u179F\u17CB\u1791\u17C1\u17D4</b>", BACK_SETTINGS_KB);
    return;
  }
  const lines = [`\u{1F465} \u17A2\u17D2\u1793\u1780\u1794\u17D2\u179A\u17BE\u1794\u17D2\u179A\u17B6\u179F\u17CB\u179F\u179A\u17BB\u1794: ${rows.length}`, ""];
  for (const [uid, info] of rows) {
    ...
    lines.push(`${full}`, `   \u{1F516} ${uname}`, `   \u{1FAAA} ${uid}`, "");
  }
  const buf = Buffer.from(lines.join("\n"), "utf8");
  await sendDocument(chatId, buf, `users_${nowKHFile()}.txt`, `\u{1F465} \u1794\u1789\u17D2\u1787\u17B8\u17A2\u17D2\u1793\u1780\u1794\u17D2\u179A\u17BE\u1794\u17D2\u179A\u17B6\u179F\u17CB \u2014 ${rows.length} \u1793\u17B6\u1780\u17CB`);
  await sendAdminSettingsMenu(ctx, chatId);
}
async function sendKhpayInfo(ctx, chatId) {
  ...
  const lines = [
    "\u{1F4B0} <b>Cambo Payment Info</b>",
    "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501",
    "\u{1F310} <b>API:</b> <code>bakong.cambo-kh.com/api/v2</code>",
    `\u{1F511} <b>Token:</b> ${short}`,
    "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501",
...
async function runBroadcast(ctx, adminChatId, bcastText) {
  ...
  await sendMessage(
    adminChatId,
    `\u{1F4E2} <b>\u1795\u17D2\u179F\u17B6\u1799\u200B\u179F\u17B6\u179A\u200B\u1794\u17B6\u1793\u200B\u1785\u1794\u17CB</b>
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
\u{1F465} \u179F\u179A\u17BB\u1794:         ${uids.length}
\u2705 \u1795\u17D2\u1789\u17BE\u200B\u1787\u17C4\u1782\u1787\u17D0\u1799:   ${sent}
...
async function dispatchAdminButton(ctx, chatId, uid, btn) {
  switch (btn) {
    ...
    case BTN_DELETE_TYPE: {
      const types2 = Object.keys(ctx.db.accounts.account_types);
      if (!types2.length) return sendMessage(chatId, "\u26A0\uFE0F <b>\u1798\u17B7\u1793\u1798\u17B6\u1793\u1794\u17D2\u179A\u1797\u17C1\u1791 \u1782\u17BC\u1794\u17C9\u17BB\u1784 \u178E\u17B6\u1798\u17BD\u1799\u1791\u17C1!</b>");
      const labelsMap = {};
      const rows = types2.map((t) => {
      ...
      return sendMessage(chatId, "\u{1F5D1} <b>\u1787\u17D2\u179A\u17BE\u179F\u179A\u17BE\u179F\u1794\u17D2\u179A\u1797\u17C1\u1791 \u1782\u17BC\u1794\u17C9\u17BB\u1784 \u178A\u17C2\u179B\u1785\u1784\u17CB\u179B\u17BB\u1794\u17D6</b>", { keyboard: rows, resize_keyboard: true, is_persistent: true });
    }
    case BTN_STOCK:
      return exportStock(ctx, chatId);
    case BTN_BUYERS:
      return exportBuyers(ctx, chatId);
    case BTN_USERS:
      return showUsersList(ctx, chatId);
    case BTN_KHPAY:
      return sendMessage(chatId, `\u{1F4B0} <b>Cambo API Token \u1794\u1785\u17D2\u1785\u17BB\u1794\u17D2\u1794\u1793\u17D2\u1793\u17D6</b>
...
<code>${esc(ctx.CAMBO_API_TOKEN)}</code>`, KHPAY_SUBMENU_KB);
    case BTN_KHPAY_KEY_EDIT:
      ...
      return sendMessage(chatId, "\u{1F4B0} \u179F\u17BC\u1798\u1795\u17D2\u1789\u17BE <b>Cambo API Token</b> \u1790\u17D2\u1798\u17B8:\n\n<i>\u1785\u17BB\u1785 \u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB \u178A\u17BE\u1798\u17D2\u1794\u17B8\u1794\u17C4\u17C7\u1794\u1784\u17CB</i>", CANCEL_INPUT_KB);
    case BTN_KHPAY_INFO:
      return sendKhpayInfo(ctx, chatId);
    case BTN_CHANNEL: {
      const cur = ctx.CHANNEL_ID || "(\u1798\u17B7\u1793\u1791\u17B6\u1793\u17CB\u1780\u17C6\u178E\u178F\u17CB)";
      return sendMessage(chatId, `\u{1F4E2} <b>Channel ID \u1794\u1785\u17D2\u1785\u17BB\u1794\u17D2\u1794\u1793\u17D2\u1793\u17D6</b>
<code>${esc(String(cur))}</code>`, CHANNEL_SUBMENU_KB);
    }
    case BTN_CHANNEL_EDIT:
      ctx.db.sessions[String(uid)] = { state: "admin_input:channel" };
      return sendMessage(chatId, "\u{1F4E2} \u179F\u17BC\u1798\u1795\u17D2\u1789\u17BE <b>Channel ID</b> \u1790\u17D2\u1798\u17B8 (\u17A7. <code>-1001234567890</code>):\n\n<i>\u1785\u17BB\u1785 \u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB \u178A\u17BE\u1798\u17D2\u1794\u17B8\u1794\u17C4\u17C7\u1794\u1784\u17CB</i>", CANCEL_INPUT_KB);
    ...
    case BTN_ADMINS: {
      ...
      return sendMessage(chatId, `\u{1F451} <b>Admin \u1794\u178B\u1798\u17D6</b> <code>${ctx.ADMIN_ID}</code>
...
${extrasStr}`, ADMINS_SUBMENU_KB);
    ...
    case BTN_MAINTENANCE: {
      const status = ctx.MAINTENANCE_MODE ? "\u{1F534} \u1794\u17B7\u1791" : "\u{1F7E2} \u1794\u17BE\u1780";
      return sendMessage(chatId, `\u{1F6E0} <b>\u179F\u17D2\u1790\u17B6\u1793\u1797\u17B6\u1796 Bot \u1794\u1785\u17D2\u1785\u17BB\u1794\u17D2\u1794\u1793\u17D2\u1793\u17D6</b> ${status}`, MAINTENANCE_SUBMENU_KB);
    }
    case BTN_MAINT_ON:
      ctx.db.settings.MAINTENANCE_MODE = "true";
      ctx.MAINTENANCE_MODE = true;
      return sendMessage(chatId, "\u{1F534} \u1794\u17B6\u1793\u1794\u17B7\u1791 Bot", ADMIN_SETTINGS_KB);
    case BTN_MAINT_OFF:
      ctx.db.settings.MAINTENANCE_MODE = "false";
      ctx.MAINTENANCE_MODE = false;
      return sendMessage(chatId, "\u{1F7E2} \u1794\u17B6\u1793\u1794\u17BE\u1780 Bot", ADMIN_SETTINGS_KB);
    case BTN_BROADCAST:
      ctx.db.sessions[String(uid)] = { state: "admin_input:broadcast" };
      return sendMessage(chatId, "\u{1F4E2} \u179F\u17BC\u1798\u1795\u17D2\u1789\u17BE\u200B\u179F\u17B6\u179A\u200B\u178A\u17C2\u179B\u200B\u1785\u1784\u17CB\u200B\u1795\u17D2\u179F\u17B6\u1799\u200B\u1791\u17C5\u200B\u17A2\u17D2\u1793\u1780\u200B\u1794\u17D2\u179A\u17BE\u200B\u1794\u17D2\u179A\u17B6\u179F\u17CB\u200B\u1791\u17B6\u17C6\u1784\u200B\u17A2\u179F\u17CB\u17D6\n\n<i>\u1785\u17BB\u1785 \u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB \u178A\u17BE\u1798\u17D2\u1794\u17B8\u1794\u17C4\u17C7\u1794\u1784\u17CB</i>", CANCEL_INPUT_KB);
    default:
      return sendAdminSettingsMenu(ctx, chatId);
  }
}
async function handleAdminInput(ctx, chatId, uid, msgId, key, text) {
  const cancelWords = /* @__PURE__ */ new Set(["\u1794\u17C4\u17C7\u1794\u1784\u17CB", "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB", BTN_CANCEL_INPUT, BTN_BACK_SETTINGS]);
  if (cancelWords.has(text)) {
    delete ctx.db.sessions[String(uid)];
    return sendAdminSettingsMenu(ctx, chatId);
  }
  if (key === "khpay_key") {
    if (!text) return sendMessage(chatId, "\u274C Token \u1798\u17B7\u1793\u178F\u17D2\u179A\u17B9\u1798\u178F\u17D2\u179A\u17BC\u179C\n\n\u179F\u17BC\u1798\u1795\u17D2\u1789\u17BE Token \u178F\u17D2\u179A\u17B9\u1798\u178F\u17D2\u179A\u17BC\u179C (\u17AC\u1785\u17BB\u1785 \u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB)");
...
<code>${esc(text.slice(0, 12))}\u2026${esc(text.slice(-4))}</code>`, await mainKb(ctx, uid));
  ...
  if (key === "admin_add") {
    ...
    if (isNaN(target)) return sendMessage(chatId, "\u274C user_id \u178F\u17D2\u179A\u17BC\u179C\u178F\u17C2\u1787\u17B6\u179B\u17C1\u1781 (\u17AC\u1785\u17BB\u1785 \u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB)");
  ...
  if (key === "broadcast") {
    ...
    return sendMessage(chatId, `\u{1F4E2} <b>\u1796\u17D2\u179A\u1798\u1796\u17D2\u179A\u17C0\u1784\u1795\u17D2\u179F\u17B6\u1799:</b>
...
async function handleUpdate(update, preDb) {
...
async function handleMessage(ctx, msg) {
  ...
  if (text === "/start" || text.startsWith("/start ")) {
    if (ctx.MAINTENANCE_MODE && !isAdmin(ctx, uid)) {
      await sendMessage(chatId, "\u{1F527} <b>Bot \u1780\u17C6\u1796\u17BB\u1784 Update \u179F\u17BC\u1798\u179A\u1784\u17CB\u1785\u17B6\u17C6\u1798\u17BD\u1799\u1797\u17D2\u179B\u17C2\u178F...</b>");
      return;
    }
    const sess = ctx.db.sessions[String(uid)];
    if (sess?.state === "payment_pending") {
      await sendMessage(chatId, "\u23F3 <b>\u179F\u17BC\u1798\u1794\u1789\u17D2\u1785\u1794\u17CB\u1780\u17B6\u179A\u1791\u17B7\u1789\u1794\u1785\u17D2\u1785\u17BB\u1794\u17D2\u1794\u1793\u17D2\u1793\u1787\u17B6\u1798\u17BB\u1793\u179F\u17B7\u1793</b>\n\n\u17A2\u17D2\u1793\u1780\u1798\u17B6\u1793\u1780\u17B6\u179A\u1794\u1789\u17D2\u1787\u17B6\u1791\u17B7\u1789\u1798\u17BD\u1799\u1780\u17C6\u1796\u17BB\u1784\u178A\u17C6\u178E\u17BE\u179A\u1780\u17B6\u179A\u17D4 \u179F\u17BC\u1798\u1794\u1789\u17D2\u1785\u1794\u17CB\u1780\u17B6\u179A\u1791\u17BC\u1791\u17B6\u178F\u17CB \u17AC\u1785\u17BB\u1785 <b>\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB</b> \u1798\u17BB\u1793\u1793\u17B9\u1784\u1785\u17B6\u1794\u17CB\u1795\u17D2\u178F\u17BE\u1798\u1780\u17B6\u179A\u1791\u17B7\u1789\u1790\u17D2\u1798\u17B8\u17D4");
      return;
    }
    delete ctx.db.sessions[String(uid)];
    if (isAdmin(ctx, uid)) {
      await sendMessage(chatId, "\u{1F44B} <b>\u179F\u17BD\u179F\u17D2\u178A\u17B8 Admin</b>", await mainKb(ctx, uid));
    }
  ...
  if (isAdmin(ctx, uid)) {
    ...
    if (state === "delete_type_select") {
      ...
      if (typeName && ctx.db.accounts.account_types[typeName] !== void 0) {
...
<blockquote>\u{1F539} \u1794\u17D2\u179A\u1797\u17C1\u1791: ${esc(typeName)}
\u{1F539} \u1785\u17C6\u1793\u17BD\u1793: ${count}
\u{1F539} \u178F\u1798\u17D2\u179B\u17C3: $${price}</blockquote>`,
    ...
    if (state === "delete_type_confirm") {
      ...
      return sendMessage(chatId, "\u{1F6AB} <b>\u1794\u17B6\u1793\u1794\u17C4\u17C7\u1794\u1784\u17CB\u1780\u17B6\u179A\u179B\u17BB\u1794</b>", ADMIN_SETTINGS_KB);
    }
    if (state === "broadcast_confirm") {
      const bcastText = sess.broadcast_text || "";
      delete ctx.db.sessions[String(uid)];
      if (text === BTN_BROADCAST_CONFIRM && bcastText) {
        await sendMessage(chatId, "\u{1F4E2} \u1780\u17C6\u1796\u17BB\u1784\u200B\u1795\u17D2\u179F\u17B6\u1799\u200B\u179F\u17B6\u179A ... \u179F\u17BC\u1798\u179A\u1784\u17CB\u1785\u17B6\u17C6", ADMIN_SETTINGS_KB);
        await saveDB(ctx.db);
        await runBroadcast(ctx, chatId, bcastText);
        return;
      }
      return sendMessage(chatId, "\u{1F6AB} <b>\u1794\u17B6\u1793\u200B\u1794\u17C4\u17C7\u1794\u1784\u17CB\u200B\u1780\u17B6\u179A\u200B\u1795\u17D2\u179F\u17B6\u1799</b>", ADMIN_SETTINGS_KB);
    }
...
\u178F\u1798\u17D2\u179B\u17C3\u178F\u17D2\u179A\u17BC\u179C\u178F\u17C2\u178A\u17BC\u1785\u1782\u17D2\u1793\u17B6 (${existingPrice}$) \u178A\u17BE\u1798\u17D2\u1794\u17B8\u1794\u1793\u17D2\u1790\u17C2\u1798 \u1782\u17BC\u1794\u17C9\u17BB\u1784</b>`, ADD_ACCOUNT_KB);
    ...
    if (state === "waiting_for_price") {
      ...
      if (existingPrice != null && Math.round(existingPrice * 1e4) !== Math.round(price * 1e4)) {
        return sendMessage(
          chatId,
          `\u274C <b>\u1798\u17B7\u1793\u17A2\u17B6\u1785\u1794\u1789\u17D2\u1785\u17BC\u179B\u1794\u17B6\u1793!</b>
...
\u178F\u1798\u17D2\u179B\u17C3 <b>${price}$</b> \u1798\u17B7\u1793\u178A\u17BC\u1785\u1782\u17D2\u1793\u17B6\u17D4 \u179F\u17BC\u1798\u1794\u17D2\u179A\u17BE <b>${existingPrice}$</b>`,
      ...
      ctx.db.accounts.prices[accountType] = Math.round(price * 1e4) / 1e4;
      delete ctx.db.sessions[String(uid)];
      await sendMessage(chatId, `\u2705 <b>\u1794\u17B6\u1793\u1794\u1789\u17D2\u1785\u17BC\u179B \u1782\u17BC\u1794\u17C9\u17BB\u1784 \u178A\u17C4\u1799\u1787\u17C4\u1782\u1787\u17D0\u1799</b>

<blockquote>\u{1F539} \u1785\u17C6\u1793\u17BD\u1793: ${toAdd.length}
\u{1F539} \u1794\u17D2\u179A\u1797\u17C1\u1791: ${esc(accountType)}
\u{1F539} \u178F\u1798\u17D2\u179B\u17C3: ${price}$</blockquote>` + (dupes ? `
...
async function handleCallback(ctx, cb) {
  ...
  if (data.startsWith("buy:")) {
    ...
    if (pool.length <= 0) return sendMessage(chatId, `<i>\u179F\u17BC\u1798\u17A2\u1797\u17D0\u1799\u1791\u17C4\u179F \u1782\u17BC\u1794\u17C9\u17BB\u1784 ${esc(at)} \u17A2\u179F\u17CB\u1796\u17B8\u179F\u17D2\u178F\u17BB\u1780 \u{1FAA4}</i>`);
    ...
    rows.push([{ text: "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB", callback_data: "cancel_buy" }]);
    if (msgId) {
...
\u{1F539} \u178F\u1798\u17D2\u179B\u17C3: $${price}</blockquote>`,
      { inline_keyboard: [[
        ...
        { text: "\u{1F6AB} \u1794\u17C4\u17C7\u1794\u1784\u17CB", callback_data: "dtcancel" }
      ]] }
    );
    return;
  }
  ...
  if (data === "dtcancel" && isAdmin(ctx, uid)) {
    ...
    await sendMessage(chatId, "\u{1F6AB} <b>\u1794\u17B6\u1793\u1794\u17C4\u17C7\u1794\u1784\u17CB\u1780\u17B6\u179A\u179B\u17BB\u1794</b>");
    return;
  }
  await answerCallbackQuery(cb.id);
}
async function handleChannelPost(ctx, post) {
  try {
    ...
    const matched = ctx.db.purchases.filter(
      (p) => (p.accounts || []).some((a) => (a.email || a.code || "").trim().toLowerCase() === email.toLowerCase())
    );
    if (!matched.length) {
    ...
    for (const p of matched) {
      ...
      sent.add(p.user_id);
      const msg = `\u{1F4E9} <b>\u179B\u17C1\u1781\u1780\u17BC\u178A\u1795\u17D2\u1791\u17C0\u1784\u1795\u17D2\u1791\u17B6\u178F\u17CB E-GetS</b>
